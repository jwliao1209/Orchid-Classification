...
def _cfg(url='', **kwargs):
    return {
        'url': url,
        'num_classes': 1000, 'input_size': (3, 214, 214), 'pool_size': None,
...
class CSWinTransformer(BaseModule):
    ...
    """
    def __init__(self, img_size=384, patch_size=16, in_chans=3, num_classes=1000, embed_dim=96, depth=[2,2,6,2], split_size = [3,5,7],
