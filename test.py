...
def test(args, model):
    ...
    testset = datasets.ImageFolder(os.path.join(args.test_dir, 'test'), transform=transform_test)
    ...
    print(classification_report(all_label[0], all_preds[0], target_names=[str(i) for i in range(args.num_classes)]))
...
def main():
    ...
    parser.add_argument("--test_dir", default='../datasets/origin',
